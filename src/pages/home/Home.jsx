...
// Importing mui items
import { Container, Stack, Divider, Grid, Paper } from "@mui/material";
 ...
 return (
  <Container align="center">
   <Stack spacing={{ xs: 1, sm: 2, md: 4 }}>
    ...
    <Grid container spacing={{ xs: 2, sm: 2, md: 5 }} columns={{ xs: 2, md: 12 }} rowSpacing={3} justifyContent={{ xs: "center", md: "start" }} alignItems="center">
     {data
      .filter((product) => {
