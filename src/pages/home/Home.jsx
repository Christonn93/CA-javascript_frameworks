...
const Home = () => {
 ...
 return (
  <Container align="center">
   <Box sx={{ width: '100%' }}>
    <Stack spacing={{ xs: 1, sm: 2, md: 4 }} bgcolor={"orange"}>
     <Paper
      elevation={0}
      sx={{
       textAlign: "center",
     ...
     <Grid container spacing={2} columns={{ xs: 2, md: 12 }} rowSpacing={3} justifyContent={{ xs: "center", md: "start" }} alignItems="center" bgcolor={"lightgrey"} >
      {data
       .filter((product) => {
